...
public class RadioClaseA implements MetodosClaseA{
	...
	private String NombreUltimoContacto;
	
	public RadioClaseA(ArrayList<Cancion> ListaDeReproduccion){
	...
	public String getMensajeModoTelefono(){
		...
		if(NombreUltimoContacto!=null){
			mensaje = "\tEstado de la radio: " + estado + "\n\tModo:" + modo + "\n\tVolumen: " + volumen  + "\n\tEstado del telefono: " + EstadoTelefono + "\n\tNombre del ultimo contacto con el que se hablo: " + NombreUltimoContacto;
	...
	public String MenuOpcionesModoTelefono(){
		String mensaje = "1.\tCambiar modo de la radio\n2.\tCambiar volumen a la radio\n3.\tConectar/Desconectar telefono\n4.\tMostrar contactos\n5.\tLlamar a contacto\n6.\tLlamar al ultimo contacto con el que se hablo\n7.\tApagar la radio\n8.\tSalir";
		return mensaje;
	}
	
	public String MenuOpcionesModoProductividad(){
		String mensaje = "1.\tCambiar modo de la radio\n2.\tCambiar volumen a la radio\n3.\tVer tarjetas de presentacion\n4.\tApagar la radio\n5.\tSalir";
		return mensaje;
	}
