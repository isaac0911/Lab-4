...
public class RadioClaseS implements MetodosClaseS{
	...
	public RadioClaseS(ArrayList<Cancion> ListaDeReproduccion){
	...
	public String getMensajeModoTelefono(){
		...
		String SalidaDeAudio = "";
		if(Bocinas){
			SalidaDeAudio = "Bocinas";
		}else if(!Bocinas){
			SalidaDeAudio = "Auriculares";
		}
		
		String mensaje = "\tEstado de la radio: " + estado + "\n\tModo:" + modo + "\n\tVolumen: " + volumen  + "\n\tEstado del telefono: " + EstadoTelefono + "\n\tSalida de audio: " + SalidaDeAudio;
	...
	public String MenuOpcionesModoTelefono(){
		String mensaje = "1.\tCambiar modo de la radio\n2.\tCambiar volumen a la radio\n3.\tConectar/Desconectar telefono\n4.\tMostrar contactos\n5.\tLlamar a contacto\n6.\tCambiar a bocinas o auriculares\n7.\tApagar la radio\n8.\tSalir";
		return mensaje;
	}
